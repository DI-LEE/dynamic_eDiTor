...
class ModelParams(ParamGroup):
    def __init__(self, parser, sentinel=False):
        ...
        self.edit_fps = 1  # FPS for editing data (30 = use all frames)
        self.layer_range = "0,29" # string format "start,end" will be parsed to tuple
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.edit_iterations = 60_000
        self.editing_warmup_iter = 100
        self.DU_interval = 50
        self.local_vis_log_interval = 100
